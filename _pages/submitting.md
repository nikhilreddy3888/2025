...
To create a blog post in Markdown format, you can modify the [example]({% post_url 2025-04-28-multimodal-vector-search %}) Markdown post `_posts/2025-04-28-distill-example.md` and rename it to `_posts/2025-04-28-[SUBMISSION NAME].md`, where `[SUBMISSION NAME]` is the name of your submission. You can see the result of the sample post .
...
Read our [sample blog post]({% post_url 2025-04-28-multimodal-vector-search %}) carefully to see how you can add image assets, and how to write using $$\LaTeX$$!
